...
-- Keep authorization in server-controlled app_metadata and never expose the
-- private guest table to anonymous visitors. This block is idempotent and is
-- mirrored in supabase/migrations/20260906015352_harden_existing_schema.sql.
